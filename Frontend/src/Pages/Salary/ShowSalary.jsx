          ...
          {loading ? (
            ...
            <div className="flex flex-col border-2 border-black rounded-xl w-[600px] p-4 mx-auto ">
              ...
              <div className="my-4">
                ...
                <span className="font-bold text-black">{salary.staff_id}</span>
              </div>
              <div className="my-4">
                <span className="text-xl mr-4 text-gray-500 font-bold text-blue-500">
                  Name
              ...
              <div className="my-4">
                ...
                <span className="font-bold text-black">{salary.hours}</span>
              </div>
              <div className="my-4">
                <span className="text-xl mr-4 text-gray-500 font-bold text-blue-500">
                  Days
              ...
              <div className="my-4">
                ...
                <span className="font-bold text-black">
                  {new Date(salary.createdAt).toString()}
                </span>
              </div>
              <div className="my-4">
                <span className="text-xl mr-4 text-gray-500 font-bold text-blue-500">
                ...
                <span className="font-bold text-black">
                  {new Date(salary.updatedAt).toString()}
                </span>
              </div>
            </div>
          )}
