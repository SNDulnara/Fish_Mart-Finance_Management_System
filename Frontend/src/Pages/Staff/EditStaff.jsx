...
const EditStaff = () => {
  ...
  const handleEditStaff = () => {
    ...
    setLoading(true);
    axios
      .put(`http://localhost:3000/api/staff/${_id}`, data)
      .then(() => {
        setLoading(false);
      ...
      .catch((error) => {
        setLoading(false);
        enqueueSnackbar("Error updating staff member", { variant: "error" });
        console.log(error);
      });
  };
      ...
      <div className="min-h-screen">
        <div className="p-4">
          ...
          <div className="flex flex-col border-2 border-black rounded-xl w-[600px] p-4 mx-auto">
            <div className="my-4">
              <label className="text-xl mr-4 text-gray-500">Staff ID</label>
              <input
                type="text"
                value={staff_id}
                readOnly
